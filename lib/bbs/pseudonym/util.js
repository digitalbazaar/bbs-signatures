...
import {generateRandomScalar} from '../util.js';

// Note: This file uses naming conventions that match the IETF BBS RFCs.

// FIXME: attempt to consolidate with core `calculate_B()`
export async function B_calculate_with_nym({
  generators, commitment, nym_generator, message_scalars, ciphersuite
} = {}) {
  /*
  Inputs:
  ...
  */
  ...
  const signer_nym_entropy = await generateRandomScalar(ciphersuite);
