...
// FIXME: should receive a better name and / or another utility method should
// expose composing the `nym_secret` from `prover_nym` and `signer_nym_entropy`
// without need for the additional verification step
export async function Finalize({
  ...
  */
  ...
  const res = await BlindVerify({
    PK, signature, header, messages,
    committed_messages: [...committed_messages, nym_secret],
...
// FIXME: older functions that need adaption based on new spec where they are
// presently underspecified
