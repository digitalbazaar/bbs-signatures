...
export async function ProofGenWithPseudonym({
  ...
  /* Note: The only difference between this and `ProofGen` is the appending
  of `pid` to `messages` and the passing of `Pseudonym`, `verifier_id`,
  `pid_scalar` to `CoreProofGenWithPseudonym` instead of `CoreProofGen`. */
...
// FIXME: needs update to latest spec
