...
export const CIPHERSUITES = {
  BLS12381_SHAKE256: {
    ...
    BP1: bls12_381.G1.Point.BASE,
    BP2: bls12_381.G2.Point.BASE,
    E1: bls12_381.fields.Fp,
    E2: bls12_381.fields.Fp2,
    Identity_E1: bls12_381.G1.Point.ZERO,
    Identity_E2: bls12_381.G2.Point.ZERO,
    P1: bls12_381.G1.Point.fromHex(
...
// `@noble/curves` serializes points in compressed format using `toBytes()`
function _pointToOctets(p) {
  return p.toBytes();
}

function _octetsToG1Point(octets) {
  return bls12_381.G1.Point.fromBytes(octets);
}

function _octetsToG2Point(octets) {
  return bls12_381.G2.Point.fromBytes(octets);
}
